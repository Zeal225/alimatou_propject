<?php require 'header.php';?>
          ...
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                ...
                <span>Pour les commandes de plus de 10.000 FCFA</span>
              </div>
            </div>      
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                <h3 class="heading">Produit toujours frais</h3>
                <span>Mangez sain avec nous</span>
              </div>
            </div>    
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                <h3 class="heading">Qualit&eacute; Sup&eacute;rieur</h3>
                <span>Tous nos produits sont de qualit&eacute;</span>
              </div>
            </div>      
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
				...
				<div class="row">
							...
							<div class="col-md-6 order-md-last align-items-stretch d-flex">
								<div class="category-wrap-2 ftco-animate img align-self-stretch d-flex" style="background-image: url(images/category.jpg);">
									<div class="text text-center">
										<h2>Fast-Food</h2>
										<p>D&eacute;gustez les plats de l'un des meilleurs Fast-Food</p>
										<p><a href="shop.php" class="btn btn-primary">Commandez maintenant</a></p>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/category-1.jpeg);">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="burger&tacos.php">Burgers & Tacos</a></h2>
									</div>
								</div>
								<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(images/category-2.jpg);">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="pizzas.php">Pizzas</a></h2>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-4">
						<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/category-3.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="drinks.php">Cocktails</a></h2>
							</div>		
						</div>
						<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(images/category-4.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="ice_cream.php">Ice Cream</a></h2>
							</div>
						</div>
					</div>
				</div>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
          	<span class="subheading">R&eacute;galez vous avec</span>
            <h2 class="mb-4">Nos Produits</h2>
            <p>Faites vous plaisir avec les bons plats de Chez RIFAT</p>
          </div>
        </div>   	
    	</div>
    	<div class="container">
    ...
    <img class="img-fluid" src="admin1/assets/images/<?= $product ->images; ?>" alt="Colorlib Template">
		...
		<section class="ftco-section img" style="background-image: url(images/category-3.jpg);">
    	<div class="container">
