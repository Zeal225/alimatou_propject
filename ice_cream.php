 ...
 <section class="ftco-section">
    ...
    <img class="img-fluid" src="img/<?= $product ->id; ?>.jpg" alt="Colorlib Template">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc"><?= number_format($product->prix,2,',',' ');echo" FCFA";?></span><br/>
		    							<span class="price-sale"><?=number_format($product->prix-($product->prix*$product->remise)/100,2,',',' ');echo" FCFA/Boules";?></span></p>
		    					</div>
